    ...
    if update_channel:
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton('Support Channel', url='https://t.me/Stark_support'),
                    InlineKeyboardButton('Feedback', url='https://t.me/tony_strak_3000')
                ],
                [
                    InlineKeyboardButton('Other Bots', url='https://t.me/Stark_botz'),
                    InlineKeyboardButton('Source', url='https://t.me/Stark_botz')
                ]
            ]
        ),
